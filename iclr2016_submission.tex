...
\title{The Incredible Shrinking Neural Network:  Pruning to Operate in Constrained Memory Environments Using 2nd Order Approximations}
...
\section{Submission of conference papers to ICLR 2016}
